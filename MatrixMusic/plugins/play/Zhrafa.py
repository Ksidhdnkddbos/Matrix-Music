...
async def zahrafa(c: Client, m: Message):
    ...
    if len(text_list) < 2:
        await m.reply_text("- حسنا قم بأرسال اسمك بلغة الانكليزية او العربية فقط 🥢", reply_to_message_id=m.message_id)
        return

    zhrf = re.sub('ض', 'ضِ', text)
    zhrf = re.sub('ص', 'صِ', zhrf)
    zhrf = re.sub('ث', 'ثَ', zhrf)
    ...
    zhrf = re.sub('ش', 'شِ', zhrf)
    zhrf = re.sub('س', 'سِ', zhrf)
    zhrf = re.sub('ي', 'يَ', zhrf)
    zhrf = re.sub('ب', 'بَ', zhrf)
    zhrf = re.sub('ل', 'ݪ', zhrf)
    zhrf = re.sub('ا', 'اެ', zhrf)
    zhrf = re.sub('ت', 'تَ', zhrf)
    zhrf = re.sub('ن', 'نِ', zhrf)
    zhrf = re.sub('م', 'مِ', zhrf)
    zhrf = re.sub('ك', 'كَ', zhrf)
    zhrf = re.sub('ط', 'طَ', zhrf)
    zhrf = re.sub('ظ', 'ظِ', zhrf)
    zhrf = re.sub('ء', 'ء', zhrf)
    zhrf = re.sub('ر', 'ࢪ', zhrf)
    zhrf = re.sub('ى', 'ى', zhrf)
    zhrf = re.sub('ؤ', 'ؤِ', zhrf)
    zhrf = re.sub('ز', 'ࢪ࣪', zhrf)
    zhrf = re.sub('ه', 'هِ', zhrf)
    zhrf = re.sub('د', 'دَ', zhrf)
