...
async def moderngame(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    newgames = "↯︙قائمة الالعاب المتطورة"
    keyboard = InlineKeyboardMarkup(inline_keyboard=[

        [InlineKeyboardButton("‹ فلابي بيرد ›", url="http://t.me/awesomebot?game=FlappyBird")],
        [InlineKeyboardButton("‹ تبديل النجوم ›", url="http://t.me/gamee?game=Switchy")] +
        [InlineKeyboardButton("‹ الموتيسكلات ›", url="http://t.me/gamee?game=motofx")],
        [InlineKeyboardButton("‹ تجميع الالوان ›", url="http://t.me/awesomebot?game=Hextris")] +
        [InlineKeyboardButton("‹ المجوهرات ›", url="http://t.me/gamee?game=DiamondRows")],
        [InlineKeyboardButton("‹ كره القدم ›", url="http://t.me/gamee?game=Footballstar")] +
        [InlineKeyboardButton("‹ اطلاق النار ›", url="http://t.me/gamee?game=NeonBlaster")],
        [InlineKeyboardButton("‹ ركل الكره ›", url="http://t.me/gamee?game=KeepitUP")] +
        [InlineKeyboardButton("‹ بطوله السحق ›", url="http://t.me/gamee?game=SmashRoyale")],
        [InlineKeyboardButton("‹ السمك الشائك ›", url="http://t.me/gamee?game=SpikyFish3")] +
        [InlineKeyboardButton("‹ الحفر العميق ›", url="http://t.me/gamee?game=BigDig")],
        ...
        [InlineKeyboardButton("‹ رجوع ›", callback_data="allgame2 " + str(m.from_user.id))],
...
async def sourcegame(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="الامر لايخصك انقلع", show_alert=True)
        return
    game_message = """- قائمه الالعاب البوت ↫  ⦗ ⤈ ⦘
— — — — — — — — — — — —
↯︙لعبه XO ↫ اكس او
↯︙لعبة الصراحه ↫ صراحه
↯︙لعبة مريم ↫ مريم
...
— — — — — — — — — — — —
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("‹ رجوع ›", callback_data="allgame2 " + str(m.from_user.id))],
        [InlineKeyboardButton("‹ 𝖬𝖺𝖳𝗋𝗂x 𝖳𝖾𝖠𝗆 ›",
...
async def games2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("‹ الالعاب المتطوره ›", callback_data="moderngame " + str(m.from_user.id))],
                [InlineKeyboardButton("‹ 𝖬𝖺𝖳𝗋𝗂x 𝖳𝖾𝖠𝗆 ›",
                              url=f"https://t.me/XMATTMX")],

    ])
    await m.message.edit_text("↯︙أهلا بيك بقائمه العاب سورس ماتركس قم باختيار احدى الازرار\n↯", reply_markup=keyboard)
